...
import '../../business_logic/provider/signup_student_provider.dart';
import '../../data/model/signup_student_request_model.dart';

// Sign Up Student Screen Design
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Consumer<SignUpStudentProvider>(
                        ...
                        onPressed: provider.isLoading
                            ...
                            : () async {
                                if (_formKey.currentState!.validate()) {
                                  bool success = await provider.signupStudent(
                                      requestModel: SignUpStudentRequestModel(
